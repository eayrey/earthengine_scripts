//DEMO for creating cloud free annual landsat composites. User must copy/paste this into the earth engine interface, and specify a geometry.
...
var composites =generate_historical_composites(geometry, 1984, 2021, 0, 365);

var one_year = composites.filterDate(ee.Date.fromYMD(2000, 1, 1), ee.Date.fromYMD(2000, 12, 31)).median();
